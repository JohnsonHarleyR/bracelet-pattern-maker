...
const DecoderModal = ({showCode, setShowCode}) => {
  ...
  const strandStringInput = useRef();
  const nodeStringInput = useRef();
  ...
  const copyStrandString = (evt) => {
    let text = strandStringInput.current.innerText;
    copyText(text, evt, 'strand-tip-id');
  }

  const copyNodesString = (evt) => {
    let text = nodeStringInput.current.innerText;
      ...
      <div className='modal coder'>
        ...
        <div className="modal-body coder">
          ...
          <div className='code-section'>
            ...
            <div className='strand-values'  ref={strandStringInput}>
            {strandString}
            </div>
          ...
          <div className='code-section'>
            <h4>Knot Setup</h4>
            <div className='knot-values'  ref={nodeStringInput}>
              {nodeCodeDisplay}
            </div>
            <div className='copy-btn-div'>
              <button
